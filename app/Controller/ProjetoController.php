...
class ProjetoController extends AppController {
	...
	public function beforeFilter(){
		parent::beforeFilter();
    	$this->Auth->allowedActions = array('cronograma', 'exibirGrafico', 'exibirGantt');
	}
 ...
 */
	public function index() {
		...
		if($verifica_permissao){
			...
			$this->Session->setFlash("Você não tem acesso ao item Projeto", 'alert');
 ...
 */
	public function visualizar($id = null) {
		...
		if($verifica_permissao){
			...
			$this->Session->setFlash("Você não tem permissão de visualizar Projeto", 'alert');
			$this->redirect(array('action' => 'index'));
		}
	}
 ...
 */
	public function adicionar() {
		...
		if($verifica_permissao){
			...
			$this->Session->setFlash("Você não tem permissão de adicionar Projeto", 'alert');
			$this->redirect(array('action' => 'index'));
		}
	}
 ...
 */
	public function editar($id = null) {
		...
		if($verifica_permissao){
			...
			$this->Session->setFlash("Você não tem permissão de editar Projeto", 'alert');
			$this->redirect(array('action' => 'index'));
		}
	...
	public function excluir($id = null) {
		...
		if($verifica_permissao){
			...
			$this->Session->setFlash("Você não tem permissão de excluir Projeto", 'alert');
			$this->redirect(array('action' => 'index'));
		}
	}
