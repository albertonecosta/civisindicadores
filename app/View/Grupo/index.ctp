		...
		<div class="list-actions row-fluid">
			...
			<div class="list-filters pull-left">
				<div class="with-select">
					<input name="data[Grupo][busca]" placeholder="O que você procura?" type="text" id="GrupoBusca">
					<?php $options = array('Grupo.titulo' => 'Título');?>
					<select name="data[Grupo][buscar_em]" id="GrupoBuscarEm">
						<option value="Grupo.titulo">Filtrar em:</option>					
				...
				<div class="filters-tags">
					...
					if(isset($_SESSION['Search']['Grupo'])){
						if(count($_SESSION['Search']['Grupo'])>0){
						?>
