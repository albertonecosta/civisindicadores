 		...
 		<fieldset>
 			...
 			<div class="row">
  			<div class="span6"> 
	  				...
	  				<?php
	  					echo $this->Form->input('Reunia.id', array('type' => 'hidden'));
						...
						echo $this->Form->input('Reuniao.data', array('class'=>'input-xlarge data datepicker', 'type' => 'text'));
	  			...
	  			<div class="span6">
	  				...
	  				<?php 
	  					echo $this->Form->input('ReuniaoParticipante.participantes', array('class'=>'input-xlarge', 'options' => $usuarios, 'multiple' => 'multiple', 'value' => $participantes));
						echo $this->Form->input('ReuniaoConhecedor.conhecedores', array('class'=>'input-xlarge', 'options' => $usuarios, 'multiple' => 'multiple', 'value' => $conhecedores));
						echo $this->Form->input('ReuniaoEmailExterno.emails', array('class'=>'input-xlarge', 'type' => 'textarea', 'value' => $strEmail));
					?>
