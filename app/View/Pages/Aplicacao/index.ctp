		...
		<div class="row-fluid application-graphs">
			<div class="span6">
				<div class="box-graph-w-numbers">
					<div class="graph-number"><?php echo @$indicadores["diasAcoes"];?><sup>Dias</sup></div>
					<div class="graph-number-desc">Prazo médio da atividades dos projetos cadastrados
						<!-- <span class="desc-arrow negative">-5% <span class="fa fa-caret-down"></span></span>-->
					</div>
					<div id="container3" class="graph" ></div>
					<div class="graph-number-desc">Cálculo do índice de custos de seus Projetos 
			...
			<div class="span6">
				<div class="box-graph-w-numbers">
					<div class="graph-number"><?php echo $indicadores["acoesConcluidas"];?><sup>%</sup></div>
					<div class="graph-number-desc">Percentual de atividades concluídas de todos os projetos
						<!--  <span class="desc-arrow negative">-8% <span class="fa fa-caret-down"></span></span>-->
					</div>
					<div id="container4" class="graph"></div>
					<div class="graph-number-desc">Andamento médio de suas atividades
