...
<div class="container">
	...
	<div id="TargetGraphic" style="display: none">
		...
		<iframe src="http://<?php echo $_SERVER['HTTP_HOST']; ?>/graficos/ver_alvo.php?showscale=1&width=400&height=400&table_data=<?php echo $parametros;?>" width="100%" height="440" style="border: 0px;" scrolling="no"> </iframe>
	</div>
