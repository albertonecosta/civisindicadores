...
?>
<div class="container">
		<legend>Visualizar Atividade</legend>
	<div class="buttons">
		<?php
		if($editar){
		echo $this->Html->link(
			...
			<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed">
				<tbody>
					<tr>
						...
						<td> 
						<?php
						switch ($atividade['Atividade']['marco']){
							case (Util::ATIVO):
								echo "Sim";
								break;
							case (Util::INATIVO):
						...
						<td><?php echo h($atividade['Atividade']['prioridade']); ?></td>
					</tr>
					<tr>
						<td><strong><?php echo __('Data Inicial'); ?></strong></td>
						<td><?php echo h($atividade['Atividade']['data_inicio_previsto']); ?></td>
					</tr>
					<tr>
						<td><strong><?php echo __('Data final'); ?></strong></td>
						<td><?php echo h($atividade['Atividade']['data_fim_previsto']); ?></td>
					</tr>
					<tr>
						<td><strong><?php echo __('Lembrete'); ?></strong></td>
						<td><?php echo h($atividade['Atividade']['lembrete']); ?></td>
					</tr>
					<tr>
					...
					<tr>
						...
						<td><?php echo h($atividade['Atividade']['andamento']); ?></td>
					</tr>
					<tr>
						<td><strong><?php echo __('Comentário'); ?></strong></td>
						<td><?php echo nl2br(($atividade['Atividade']['observacao'])); ?></td>
					</tr>
										<tr>
						<td><strong><?php echo __('Data de conclusão'); ?></strong></td>
						<td><?php echo h($atividade['Atividade']['data_conclusao']); ?></td>
					</tr>
					<?php if(isset($atividade['Pai']['titulo'])){?>
					<tr>
						<td><strong><?php echo __('Subitem de?'); ?></strong></td>
						<td><?php echo $this->Html->link($atividade['Pai']['titulo'], array('controller' => 'Atividade','action' => 'visualizar', $atividade['Pai']['id'])); ?></td>
					</tr>
					<?php } ?>
				</tbody>				
			</table>			
			...
			<div class="box box-border box-tasks">
				...
				<div class="box-content">
					...
					<div class="post-container">
						...
						<form action="<?php echo $this->webroot; ?>Tarefa/adicionarNaAtividade/<?php echo $atividade_id;?>" id="TarefaAdicionarNaAtividadeForm" method="post" accept-charset="utf-8">
							<?php
								...
								echo $this->Form->input('Tarefa.atividade_id', array('type'=>'hidden','value' => $atividade_id));
							?>
				...
				<div class="box-content">
					...
					<table cellpadding="0" cellspacing="0" class="table table-bordered table-hover table-condensed table-forum table-forum-inner">
						...
						<tr>
							...
							<p>
								<form action="<?php echo $this->webroot; ?>Post/adicionarNaAtividade" id="PostResponderNaAtividadeForm" method="post" accept-charset="utf-8">
									<?php echo $this->Form->input("Post.atividade_id", array('type' => 'hidden', 'value' => $atividade['Atividade']['id'])); ?>
					...
					<div class="post-container">
						...
						<form action="<?php echo $this->webroot; ?>Post/adicionarNaAtividade" id="PostAdicionarNaAtividadeForm" method="post" accept-charset="utf-8">
							<?php
								echo $this->Form->input("Post.atividade_id", array('class'=>'input-xlarge', 'type' => 'hidden', 'value' => $atividade['Atividade']['id']));
