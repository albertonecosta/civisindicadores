...
<div class="container">
	...
	<div class="row">
		...
		<div class="span5">				
			...
			<div class="span1">
				<?php if($imprimir){?>
				<button class="btn btn-small btn-primary pull-left" type="button" onclick="location.href= '<?php echo $this->webroot;?>Tarefa/imprimirJobsConcluidas/<?php echo $url; ?>' ">Imprimir</button>
				<?php }?>
			</div>
		</div>
	</div>
