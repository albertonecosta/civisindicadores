		...
		<div class="list-actions row-fluid">
			...
			<div class="list-filters pull-left">
				<div class="with-select">
					<input name="data[Empresa][busca]" placeholder="O que você procura?" type="text" id="EmpresaBusca">
					<?php $options = array('Pessoa.titulo' => 'Título','Pessoa.email'=>'Email');?>
					<select name="data[Empresa][buscar_em]" id="EmpresaBuscarEm">
						<option value="Pessoa.titulo">Filtrar em:</option>					
				...
				<div class="filters-tags">
					...
					if(isset($_SESSION['Search']['Empresa'])){
						if(count($_SESSION['Search']['Empresa'])>0){
						?>
