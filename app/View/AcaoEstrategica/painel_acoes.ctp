...
<div class="container">
			...
			<div class="list-filters pull-left">
				...
				<div class="filters-tags">
					...
					if(isset($_SESSION['Search']['AcaoEstrategica'])){
						...
						?>
							<span class="type-tag"><?php echo $options[$temo_busca['buscar_em']]?>: <?php echo $temo_busca['busca']?><?php echo $this->Html->link("", array("action" => "excluirFiltro", $key, "painel_acoes"), array("class" => "fa fa-times")); ?></span>
						<?php	
							}
						}
					}
	...
	<div id="TargetGraphic" >
		<?php 
		$parametros = array();
		$acaoEstrategicas = $acaoestrategica;
		foreach($acaoEstrategicas as $acaoEstrategicas){
			
			switch ($acaoEstrategicas['AcaoEstrategica']['situacao']) {
			...
			$acaoEstrategica_titulo = explode(' - ', $acaoEstrategicas['AcaoEstrategica']['titulo']);
			$parametros[] = $acaoEstrategica_titulo[0].'|'.$acaoEstrategicas['AcaoEstrategica']['prioridade'].'|'.$acaoEstrategicas['AcaoEstrategica']['andamento'].'|'.$situacao.'|'.$acaoEstrategicas['AcaoEstrategica']['id'];
		}
	...
	<table cellpadding="0" cellspacing="0" class="footable table table-bordered table-hover table-condensed" id="index">
		<thead>
			<tr>
				<th data-hide="phone,tablet" width='10'><?php echo $this->Paginator->sort('AcaoEstrategica.situacao', 'Situação'); ?></th>
				<th data-class="expand"><?php echo $this->Paginator->sort('AcaoEstrategica.andamento', 'Andamento'); ?></th>
				<th data-class="expand"><?php echo $this->Paginator->sort('AcaoEstrategica.prioridade', 'Prioridade'); ?></th>
				...
				<th data-hide="phone,tablet"><?php echo $this->Paginator->sort('AcaoEstrategica.pdti_prazo', 'Prazo'); ?></th>
		...
		foreach($acaoestrategica as $acaoEstrategica){?>
			<tr>
				...
				<!--td><?php echo $this->Html->link($acaoEstrategica['Dimensao']['titulo'], array('controller' => 'Dimensao','action' => 'visualizar', $acaoEstrategica['Dimensao']['id'])); ?>&nbsp;</td-->
				<td><?php echo $acaoEstrategica['AcaoEstrategica']['pdti_prazo'];?></td>
