 			...
 			<div class="row">
  			<div class="span12">  				
  				<?php
					...
					echo $this->Form->input('status_medida', array('label' => 'Status','class'=>'input-xlarge', 'empty' => 'Selecione o Status','type' => 'select','options' => $status_acaoestrategica));
					...
					echo $this->Form->input('tipo', array('class'=>'input-xlarge', 'empty' => 'Selecione o tipo do medida','type' => 'select','options' => array(Util::TIPO_MEDIDA => 'Medida')));
					echo $this->Form->input('objetivo_id', array('label' => 'A que ação ou objetivo esta ação está associada?','div' => array('id' => 'acaoestrategica_id'),'class'=>'input-xlarge', 'empty' => 'Selecione a ação','type' => 'select','options' => $acoesEstrategicas, 'readonly'=>'readonly'));
							?>
