...
<div class="container">
	...
	<div id="TargetGraphic" style="display: none">
		...
		foreach($acaoEstrategica as $acaoEstrategicas){
			...
			$parametros[] = $acaoEstrategicas['AcaoEstrategica']['titulo'].'|'.$acaoEstrategicas['AcaoEstrategica']['prioridade'].'|'.$acaoEstrategicas['AcaoEstrategica']['andamento'].'|'.$situacao.'|'.$acaoEstrategicas['AcaoEstrategica']['id'];
			}
		$parametros = implode(';', $parametros);
		?>
		
		<iframe src="http://<?php echo $_SERVER['HTTP_HOST'] . $this->base; ?>/graficos/ver_alvo.php?base=<?php echo $this->base;?>&showscale=1&width=440&height=440&table_data=<?php echo $parametros;?>" width="100%" height="440" style="border: 0px;" scrolling="no"> </iframe>
	</div>
	<?php }?>
