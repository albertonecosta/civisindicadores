 ...
 */
	public function exists($id = null, $validarEmpresa = false) {
		if ($id === null) {
			$id = $this->getID();
		}
		if ($id === false) {
		...
		if($validarEmpresa){
			$conditions['or'][] =  $this->alias . '.' . 'empresa_id = ' . AuthComponent::user('empresa_id');
			$conditions['or'][] =  $this->alias . '.' . 'empresa_id is null';
		}
